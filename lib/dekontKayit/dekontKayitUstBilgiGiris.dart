...
class _DekontKayitUstBilgiState extends State<DekontKayitUstBilgi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(title: "Dekont Kayıt",height: 50,),
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Genel Bilgiler :",
                        style: TextStyle(
                            fontSize: 14, fontWeight: FontWeight.bold,color: const Color.fromARGB(
                                              255, 17, 100, 168)),
                      ),
                    ],
                  ),
            ...
            Container(
              ...
              child: ElevatedButton.icon(
                onPressed: () async {
                  ...
                  dekontEx.dekont!.value.TARIH =  DateFormat('yyyy-MM-dd').format(dekontTarihi!);
                  dekontEx.dekont!.value.SERI = contSeri.text;
                  dekontEx.dekont!.value.BELGENO = contBelge.text;
                  ...
                  dekontEx.dekont!.value.SUBEID = int.parse(Ctanim.kullanici!.YERELSUBEID!.toString());
