...
class _cari_cari_islemlerState extends State<cari_cari_islemler> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> tasarimList = [
        ...
        onTap: () {
          if (listeler.listStokFiyatListesi.isEmpty) {
            if (listeler.listSatisTipiModel.length > 0) {
              satisTipiVar(
                  context, doviAdi, anaBirimID, kurGelen, "Satis_Fatura");
            } else {
              duzGiris(doviAdi, anaBirimID, kurGelen, "Satis_Fatura");
            }
          } else {
            stokFiyatListesiKosulVar(context, "Satis_Fatura");
          }
        },
      ...
      GestureDetector(
        onTap: () {
          if (listeler.listStokFiyatListesi.isEmpty) {
            if (listeler.listSatisTipiModel.length > 0) {
              satisTipiVar(
                  context, doviAdi, anaBirimID, kurGelen, "Satis_Irsaliye");
            } else {
              duzGiris(doviAdi, anaBirimID, kurGelen, "Satis_Irsaliye");
            }
          } else {
            stokFiyatListesiKosulVar(context, "Satis_Irsaliye");
          }
        },
        child: tasarim(
            icon: Icon(
      ...
      GestureDetector(
        onTap: () {
          belgeNumarasiSor(context, "Alis_Irsaliye");
        },
        child: tasarim(
            icon: Icon(
              Icons.receipt_long,
      ...
      GestureDetector(
        onTap: () {
          if (listeler.listStokFiyatListesi.isEmpty) {
            if (listeler.listSatisTipiModel.length > 0) {
              satisTipiVar(
                  context, doviAdi, anaBirimID, kurGelen, "Musteri_Siparis");
            } else {
              duzGiris(doviAdi, anaBirimID, kurGelen, "Musteri_Siparis");
            }
          } else {
            stokFiyatListesiKosulVar(context, "Musteri_Siparis");
          }
        },
        child:
      ...
      GestureDetector(
        onTap: () {
          if (listeler.listStokFiyatListesi.isEmpty) {
            if (listeler.listSatisTipiModel.length > 0) {
              satisTipiVar(
                  context, doviAdi, anaBirimID, kurGelen, "Satis_Teklif");
            } else {
              duzGiris(doviAdi, anaBirimID, kurGelen, "Satis_Teklif");
            }
          } else {
            stokFiyatListesiKosulVar(context, "Satis_Teklif");
          }
        },
        child:
      ...
      GestureDetector(
        onTap: () {
          belgeNumarasiSor(context, "Alinan_Siparis");
        },
        child: tasarim(
      ...
      GestureDetector(
        onTap: () {
          if (listeler.listStokFiyatListesi.isEmpty) {
            if (listeler.listSatisTipiModel.length > 0) {
              satisTipiVar(
                  context, doviAdi, anaBirimID, kurGelen, "Perakende_Satis");
            } else {
              duzGiris(doviAdi, anaBirimID, kurGelen, "Perakende_Satis");
            }
          } else {
            stokFiyatListesiKosulVar(context, "Perakende_Satis");
          }
        },
        child: tasarim(
  ...
  void stokFiyatListesiKosulVar(BuildContext context, String belgeAdi) {
            ...
            builder: (context, setState) => AlertDialog(
              ...
              content: Padding(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<StokFiyatListesiModel>(
                    value: Ctanim.seciliStokFiyatListesi,
                    items: listeler.listStokFiyatListesi
                        .map((StokFiyatListesiModel banka) {
                      return DropdownMenuItem<StokFiyatListesiModel>(
                        value: banka,
                        child: Text(
                          banka.ADI ?? "",
                    ...
                    onChanged: (StokFiyatListesiModel? selected) {
                      setState(() {
                        Ctanim.seciliStokFiyatListesi = selected!;
                      });
                    },
                  ),
                ),
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          fisEx.fis?.value.cariKart = widget.cariKart!;
                          Get.to(() => genel_belge_tab_page(
                              stokFiyatListesi: Ctanim.seciliStokFiyatListesi,
                              satisTipi: Ctanim.seciliIslemTip,
                              belgeTipi: belgeAdi,
                              cariKod: widget.cariKart.KOD,
                              cariKart: widget.cariKart));
  ...
  void satisTipiVar(BuildContext context, String doviAdi, int anaBirimID,
      double kurGelen, String belgeTipi) {
    Ctanim.seciliIslemTip = listeler.listSatisTipiModel.first;
    showDialog(
        context: context,
        builder: (context) {
              ...
              content: Padding(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<SatisTipiModel>(
                    ...
                    items:
                        listeler.listSatisTipiModel.map((SatisTipiModel banka) {
