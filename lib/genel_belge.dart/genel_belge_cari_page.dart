...
class _genel_belge_cari_pageState extends State<genel_belge_cari_page> {
                                      ...
                                      onTap: () {
                                        ...
                                        if (widget.belgetipi ==
                                          ...
                                          belgeNumarasiSor(context, index,widget.belgetipi);
                                            ...
                                            .listStokFiyatListesi.isEmpty) {
                                          if (listeler
                                                  .listSatisTipiModel.length >
                                              0) {
                                            satisTipiVar(context, index);
                                          } else if (listeler
                                                  .listSatisTipiModel.length ==
                                              0) {
                                            duzGiris(index);
  ...
  void stokFiyatListesiKosulVar(BuildContext context, int index) {
  ...
  void satisTipiVar(BuildContext context, int index) {
    showDialog(
        context: context,
        builder: (context) {
          return StatefulBuilder(
