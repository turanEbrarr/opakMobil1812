...
import 'kaydedilmisDekontlarDetay.dart';
import 'package:intl/intl.dart';
import '../../widget/customAlertDialog.dart';

class kaydedilmisDekontlar extends StatefulWidget {
  final List<DekontKayitModel> gidenFisler;
  const kaydedilmisDekontlar({super.key, required this.gidenFisler});

  @override
  State<kaydedilmisDekontlar> createState() => _kaydedilmisDekontlarState();
}

class _kaydedilmisDekontlarState extends State<kaydedilmisDekontlar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(height: 50, title: "Kaydedilmiş Dekontlar"),
      body: Column(
        children: [
          Column(
            children: [
                          ...
                          setState(() async {
                            ...
                            try {
                              gidenTarihliFisler = await dekontEx
                                  .listTarihliKaydedilenDekontlariGetir(basTar, bitTar);
